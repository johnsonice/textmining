# -*- coding: utf-8 -*-
"""
Created on Mon Oct  2 09:14:22 2017
...
doc_dict = pickle.load(open('data/txt_docs.p', "rb")) 
...
#df = df[meta]
#print(df.head())
df.to_csv('data/txt_results.csv',encoding='utf-8')
...
df_word.to_csv('data/txt_word_count.csv',encoding='utf-8')
print('finished')    
